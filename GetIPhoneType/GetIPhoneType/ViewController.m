...
- (void)viewDidLoad {
    ...
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(20, 200, [UIScreen mainScreen].bounds.size.width-40, 50)];
    
    label.textAlignment = NSTextAlignmentCenter;
    
    label.text = [self getDeviceMachine];
